/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: bc194c38bf30906e2d499b4b6b6d0341)
// Runtime types generated with workerd@1.20251011.0 2025-01-27 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_SENTRY_PROJECT_KEY: string;
		SENTRY_DSN: string;
