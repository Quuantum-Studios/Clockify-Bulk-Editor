/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 8cd8be0199b048e33464412428b8dc8b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "NEXT_PUBLIC_APP_NAME" | "NEXT_PUBLIC_API_URL" | "NEXT_PUBLIC_ASSEMBLYAI_WORKER" | "CHAT_AI_PROVIDER" | "GEMINI_MODEL" | "NEXT_PUBLIC_SENTRY_DSN" | "NEXT_PUBLIC_SENTRY_PROJECT_KEY" | "SENTRY_DSN" | "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_POSTHOG_HOST" | "NEXT_PUBLIC_GOOGLE_ANALYTICS_ID">> {}
}
